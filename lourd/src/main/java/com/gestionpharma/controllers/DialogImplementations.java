...
/**
 * Classe contenant les implémentations des dialogues pour ajouter et modifier
 * les produits, fournisseurs et commandes.
 * Ces méthodes sont à copier dans la classe AdminPanelController.
 */
public class DialogImplementations {
    ...
    protected void handleEditProduct() {
        try {
            ...
            categorieField.getItems().addAll("Médicament", "Parapharmacie", "Matériel médical", "Compléments alimentaires", "Autres");
            ...
            if (selectedProduct.getDateExpiration() != null) {
                dateExpirationField.setValue(selectedProduct.getDateExpiration());
            }
