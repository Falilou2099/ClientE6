...
<body>
    ...
    <div class="login-container">
        ...
        <p class="text-center text-muted mb-4">Accès unifié pour les applications légère et lourde</p>
        ...
        <form method="POST" action="/bigpharma/login/process">
            ...
            <div class="mb-3">
                <label for="app_type" class="form-label">Type d'application</label>
                <select class="form-select" id="app_type" name="app_type">
                    <option value="light" selected>Application légère (Web)</option>
                    <option value="heavy">Application lourde (Java)</option>
                </select>
                <div class="form-text">Sélectionnez le type d'application auquel vous souhaitez accéder</div>
            </div>
