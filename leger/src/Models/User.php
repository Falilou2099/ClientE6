...
class User {
    ...
    private $createdAt;
    private $lastLogin;
    private $appAccess; // 'both', 'light', 'heavy' pour indiquer l'accès aux applications
    private static $pdo;
    ...
    // Constructeur
    public function __construct($id = null, $email = null, $password = null, $role = null, $pharmacy_id = null, $status = 'active', $createdAt = null, $lastLogin = null, $appAccess = 'both') {
        $this->id = $id;
        $this->email = $email ? SecurityService::sanitizeInput($email) : null;
        $this->password = $password;
        $this->pharmacyId = $pharmacy_id; // Correction de $pharmacyId à $pharmacy_id
        $this->role = $role;
        ...
        foreach ($data as $key => $value) {
            switch ($key) {
                ...
                case 'role':
                    ...
                    break;
                case 'appAccess':
                    $this->appAccess = in_array($value, ['both', 'light', 'heavy']) ? $value : $this->appAccess;
                    break;
            }
        }
    ...
    public function save() {
        ...
        if ($this->id === null) {
            ...
            $stmt = $pdo->prepare("
                INSERT INTO users (email, password, pharmacy_id, role, status, created_at, app_access) 
                VALUES (:email, :password, :pharmacy_id, :role, :status, :created_at, :app_access)
            ");
    ...
    public static function createFromArray($data) {
        return new self(
            ...
            $data['app_access'] ?? 'both'
        );
    }
    
    // Méthode pour enregistrer un nouvel utilisateur
    public static function register($email, $password, $pharmacyId = null, $role = 'pharmacist', $appAccess = 'both') {
        $hashedPassword = SecurityService::hashPassword($password);
        
        $user = new self(null, $email, $hashedPassword, $pharmacyId, $role, 'active', null, null, $appAccess);
    ...
    public function getPharmacyId() { return $this->pharmacy_id ?? $this->pharmacyId; } // Retourne pharmacy_id ou pharmacyId si pharmacy_id est null
    public function getRole() { return $this->role; }
    public function getStatus() { return $this->status; }
    public function getCreatedAt() { return $this->createdAt; }
    public function getLastLogin() { return $this->lastLogin; }
    public function getAppAccess() { return $this->appAccess; }
